...
if($_SESSION["login"] != 1)
	...
	include_once('header.php');//o prevent issues that might occur from redeclaring functions, classes, constants, or other code elements when the same file is included multiple times in different parts of  project
